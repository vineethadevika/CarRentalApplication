...
const Cars = () => {
  ...
  return (
    <>
<h3 style={{ textAlign: 'center', marginBottom: '10px', color: 'darkblue', backgroundColor: 'lightblue', padding: '10px', borderRadius: '5px', cursor: 'pointer' }}>Available Car Lists</h3>

...
console.log(values)
  axios.post('http://localhost:3080/ownersignup', {values})
  .then((res)=>{
    ...
    <div className="form">
      <form onSubmit={handleSubmit}>
        <div className="input-container">
          ...
          <input type="text" name="uname" placeholder="Enter Owner Name" required onChange={handlchange} />
...
<div className="input-container">
  ...
  return (
    <>
     <Nav2/>
            <h5 style={styles}>OWNER SIGNUP PAGE</h5>
